...
function InputComponent({className_Prop, spanName, spanClassName,disabled_Prop=false , type_Prop, value_Prop, onChange_Prop, placeholder}) {
    return (
        <>
         <span id='span_Element' className={spanClassName}> {spanName} </span>  
        {disabled_Prop==true
           ? 
